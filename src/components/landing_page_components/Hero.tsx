...
const Hero: React.FC = () => {
  return (
    <section className="relative bg-[#030100] overflow-hidden">
      <div className="grid w-full px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto lg:pl-4 place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4  text-4xl tracking-tight leading-none md:text-5xl xl:text-6xl text-white">
            Schedule,<br />
            Make Payments, & <br />
            Send invoice to <br />
            your customers.
          </h1>
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-gray-100">
