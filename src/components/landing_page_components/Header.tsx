...
export default () => {
    ...
    return (
        <div className='relative bg-black pt-2'>
            ...
            <div className='relative'>
                <header>
                    ...
                    <nav className={`pb-5 md:text-sm ${state ? "absolute top-0 inset-x-0 bg-black shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-0 md:mt-0 md:relative md:bg-black" : ""}`}>
