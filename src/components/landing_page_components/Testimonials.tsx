        ...
        <div className="max-w-screen-xl px-4 mx-auto text-center">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-x-0 top-1/2 transform -translate-y-1/2 z-10">
              <div className="absolute left-[-10rem] top-1/2 transform -translate-y-1/2 bg-[#FFD282] rounded-full filter blur-[120px] h-[20rem] w-[20rem] hidden sm:block"></div> 
              {/* Hidden on small screens, shown on larger screens */}
              <div className="absolute right-[-10rem] top-1/2 transform -translate-y-1/2 bg-[#FFD282] rounded-full filter blur-[120px] h-[20rem] w-[20rem] hidden lg:block"></div>
